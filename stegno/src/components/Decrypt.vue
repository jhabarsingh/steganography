<template>
  <div>
    ...
    >
      <p class="text-h4 text--primary">Encryption</p>

      <v-sheet elevation="1" style="width: 80%; margin: auto; padding: 10px">
        <v-file-input
          label="Upload Image"
        ...
        <v-btn color="primary" class="mr-4" @click="decrypt"> Decrypt </v-btn>
      </v-sheet>
    </v-sheet>
  </div>
</template>
